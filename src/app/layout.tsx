...
export const metadata: Metadata = {
  title: "Vidly - AI-Powered Video Content Tools",
  description: "Analyze comments, find viral topics, validate ideas, and search trending content with Vidly's AI-powered tools",
};
