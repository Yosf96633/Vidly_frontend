...
import { Play, Sparkles, TrendingUp, Lightbulb, Target, MessageSquare, ArrowRight, ChevronDown } from 'lucide-react';
import { motion } from 'framer-motion';import { Space_Grotesk, Outfit } from "next/font/google";
  ...
  const features = [
    {
      ...
      description: "Watch how AI analyzes thousands of comments to extract viral triggers, retention killers, and audience desires in seconds.",
    ...
    },
    {
      ...
      title: "Viral Search",
      description: "Discover the exact search strategy that finds videos outperforming their channel size by 200%+.",
      videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1",
      duration: "3:15"
    },
    {
      ...
      description: "See our AI analyze competition, audience demand, and viral potential to give your ideas a real success score.",
      videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1",
      duration: "2:45"
    },
    ...
    <div className="min-h-screen py-16 bg-black text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <span className={`text-sm ${spaceGrotesk.className} font-medium tracking-wide`}>Product Demo</span>
        </motion.div>
        ...
        >
          See <span className="bg-gradient-to-r from-[#E55A52] via-[#C83E3A] to-[#B02E2B] bg-clip-text text-transparent">Vidly</span> in Action
        </motion.h1>
        ...
        >
          Watch how Vidly transforms the way creators analyze comments, discover viral topics, 
          and validate video ideas with AI-powered intelligence.
        </motion.p>
          ...
          <div className="relative aspect-video rounded-2xl overflow-hidden bg-neutral-900 border border-white/10 shadow-2xl shadow-[#B02E2B]/20 group">
            {!isPlaying ? (
              ...
              >
                ...
                {/* Duration badge */}
                <div className={`absolute ${spaceGrotesk.className} bottom-4 right-4 bg-black/80 backdrop-blur-md px-3 py-1.5 rounded-lg border border-white/10 text-sm font-semibold`}>
                  ⏱️ 3:45
                </div>
              </div>
            ) : (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <span className={`text-sm ${spaceGrotesk.className} text-[#B02E2B] font-medium`}>What You'll Discover</span>
            </motion.div>
            ...
            >
              See firsthand how Vidly's AI-powered features revolutionize your content creation workflow
            </motion.p>
          </div>
                ...
                >
                  ...
                  <div className="relative p-8 h-full flex flex-col">
                    ...
                    <div className="flex-1 flex flex-col">
                      ...
                      <h3 className={`text-2xl ${spaceGrotesk.className} font-bold mb-3 group-hover:text-[#E55A52] transition-all duration-500 group-hover:translate-x-1`}>
                        {feature.title}
                      </h3>

                      {/* Description - Scannable Content First */}
                      <p className={`text-neutral-400 ${outfit.className} text-base leading-relaxed group-hover:text-neutral-300 transition-colors duration-500`}>
                        {feature.description}
                      </p>
                      ...
                      >
                        <span className={`text-sm ${spaceGrotesk.className} font-semibold`}>Play Demo</span>
      ...
      >
        ...
        <motion.div
          ...
          animate={{ opacity: selectedFeature !== null ? 1 : 0, scale: selectedFeature !== null ? 1 : 0.9, y: selectedFeature !== null ? 0 : 20 }}
              ...
              <>
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-8">
                  <div className="flex items-end justify-between">
                    <div>
                      <h3 className={`text-3xl ${spaceGrotesk.className} font-bold text-white mb-2`}>
                        {features[selectedFeature]?.title}
                      </h3>
                      <p className={`text-neutral-300 ${outfit.className} max-w-2xl`}>
                        {features[selectedFeature]?.description}
                      </p>
                    </div>
                    <div className={`${spaceGrotesk.className} text-neutral-400 text-lg font-semibold`}>
